...
output_file = os.path.join(root_model_folder, 'fcn_testing_samples.txt')
...
y_pred = fcn_model.predict(image_patches)
...
plt.savefig(os.path.join(root_model_folder, 'fcn_cm_heatmap_testing.png'), bbox_inches='tight')
plt.show()
...
file_path = os.path.join(root_model_folder, 'fcn_model_testing_performance_report.txt')
