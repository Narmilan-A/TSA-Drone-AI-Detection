...
#----------------------------------------------------------------------#
    ...
    if input_img.shape[0] >= patch_size and input_img.shape[1] >= patch_size:
        ...
        img_patches_processed = deeplabv3_model.predict(np.array(resized_patches))
        ...
        prediction_folder = os.path.join(root_model_folder, 'deeplabv3+_prediction_map')
...
#----------------------------------------------------------------------#
        ...
        tif_file_directory = os.path.join(root_model_folder, 'deeplabv3+_prediction_map')
