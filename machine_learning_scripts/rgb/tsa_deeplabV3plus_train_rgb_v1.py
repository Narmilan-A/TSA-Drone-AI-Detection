...
deleted_bands = [2] if delete_bands else None  # Adjust this list based on your scenario - Deleting the blue band - Index 2 mean: 3rd band
...
def DeepLabV3Plus(input_shape=(image_height, image_width, image_channels), num_classes=n_classes):
