...
root_model_folder = os.path.join(root_image_folder, f'tsa_deeplabv3_train_rgb_model&outcomes_{config_str}')
#----------------------------------------------------------------------#
...
output_file = os.path.join(root_model_folder, 'deeplabv3_testing_samples.txt')
...
plt.savefig(os.path.join(root_model_folder, 'deeplabv3_cm_heatmap_testing.png'), bbox_inches='tight')
plt.show()
...
file_path = os.path.join(root_model_folder, 'deeplabv3_model_testing_performance_report.txt')
