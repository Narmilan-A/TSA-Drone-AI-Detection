...
root_model_folder = os.path.join(root_image_folder, f'bb_last_unet_spectral_model&outcomes_{config_str}')
...
plt.savefig(os.path.join(root_model_folder, 'unet_Accuracy.png'), bbox_inches='tight')
plt.tight_layout()
plt.show()
