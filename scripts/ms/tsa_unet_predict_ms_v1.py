...
#root_data_folder = r'/home/n10837647/hpc/csu/23052024_all_model/all'
root_image_folder = r'/home/n10837647/hpc/csu/23052024_all_model/sc'
...
#root_model_folder = os.path.join(root_image_folder, f'sc_last_unet_spectral_model&outcomes_{config_str}')
root_model_folder = os.path.join(root_image_folder, f'sc_last_unet_spectral_model&outcomes')
...
#----------------------------------------------------------------------#
    ...
    if input_img.shape[0] >= patch_size and input_img.shape[1] >= patch_size:
        ...
        prediction_folder = os.path.join(root_model_folder, 'unet_prediction_map/map')
...
#----------------------------------------------------------------------#
        ...
        tif_file_directory = os.path.join(root_model_folder, 'unet_prediction_map/map')
