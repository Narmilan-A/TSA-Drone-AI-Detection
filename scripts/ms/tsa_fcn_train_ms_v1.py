...
image_channels = image_channels  # assuming RGB images

model = FCN(n_classes, image_height, image_width, image_channels)
model.summary()
#----------------------------------------------------------------------#
#Complie the model
...
plt.savefig(os.path.join(root_model_folder, 'fcn_Accuracy.png'), bbox_inches='tight')
plt.tight_layout()
plt.show()
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig(os.path.join(root_model_folder, 'fcn_loss.png'), bbox_inches='tight')
plt.tight_layout()
plt.show()
...
plt.savefig(os.path.join(root_model_folder, 'fcn_loss_from_25.png'), bbox_inches='tight')
plt.tight_layout()
plt.show()
...
plt.xlabel('Epoch')
plt.legend(loc='upper left')
plt.savefig(os.path.join(root_model_folder, 'fcn_loss_from_50.png'), bbox_inches='tight')
plt.tight_layout()
plt.show()
